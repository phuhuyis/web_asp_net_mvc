! function(t, e) {
  ...
  var v = function() {
    ...
    w = function(t) {
      ...
      m(e, t);
      var i = e.prototype;
      return i.setcolor = function(t, e) {
        ...
        for (var n = 0; n < s.length; n++) {
          switch (t = f.createElement("div", "jvm-legend-tick"), e = f.createElement("div", "jvm-legend-tick-sample"), this._series.config.attribute) {
            ...
            case "stroke":
              ...
              break;
            case "image":
              e.style.background = "url(" + (f.isObj(s[n].value) ? s[n].value.url : s[n].value) + ") no-repeat center center", e.style.backgroundcolor = "cover"
          }
  ...
  var T = Object.freeze({
      ...
      updatecolor: function() {
        this.width = this.container.width(), this.height = this.container.height(), this.recolor(), this.canvas.setcolor(this.width, this.height), this.applyTransform()
      },
