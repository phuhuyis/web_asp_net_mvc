...
$('.btn-del-category').off('click').on('click', function (e) {
    ...
    Swal.fire({
        title: "Xác nhận",
        text: "Việc xóa hãng sẽ xóa toàn bộ dữ liệu liên quan đến hãng đó (giỏ hàng, đơn hàng, giày) bạn có chắc chắn muốn xóa hay không?",
        icon: "question",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
...
$('.btn-del-product').off('click').on('click', function (e) {
    ...
    Swal.fire({
        title: "Xác nhận",
        text: "Việc xóa giày sẽ xóa toàn bộ dữ liệu liên quan đến giày đó (giỏ hàng, đơn hàng) bạn có chắc chắn muốn xóa hay không?",
        icon: "question",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
